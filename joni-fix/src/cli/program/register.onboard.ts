...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.joni.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.joni/workspace)")
    ...
    .option("--default-model <model>", "Default model (e.g. openrouter/anthropic/claude-sonnet-4-5)")
        ...
        await onboardCommand(
          {
            ...
            defaultModel: opts.defaultModel as string | undefined,
