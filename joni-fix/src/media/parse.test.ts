...
describe("splitMediaFromOutput", () => {
  ...
  it("accepts absolute path under allowedPathPrefixes for one-go image send", () => {
    const result = splitMediaFromOutput(
      "Got you.\n\nMEDIA: /home/node/.joni/workspace/purple_octopus.png",
      { allowedPathPrefixes: ["/home/node/.joni/workspace", "/home/node"] },
    );
    expect(result.mediaUrls).toEqual(["/home/node/.joni/workspace/purple_octopus.png"]);
    expect(result.text?.trim()).toBe("Got you.");
  });
});
